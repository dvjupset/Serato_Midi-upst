...
/////////////////////////////////////////////
// potentiometers
const byte NPots = 1; // *coloque aqui o numero de entradas analogicas utilizadas
const byte muxPotPin[NPots] = {15}; // *neste array coloque na ordem desejada os pinos das portas analogicas, ou mux channel, utilizadas
...
byte varThreshold = 10; //threshold para a variacao no sinal do potenciometro
...
byte note = 41; // *Nota mais grave que sera utilizada
byte cc = 2; // *CC mais baixo que sera utilizado

/////////////////////////////////////////////
// Multiplexer
Multiplexer4067 mplexPots = Multiplexer4067(2, 3, 4, 5, A0);
Multiplexer4067 mplexButtons = Multiplexer4067(2, 3, 4, 5, A1);
...
int potMidiCh () {
  int potCh =  map(mplexPots.readChannel(muxPotPin[9]), 22, 1023, 0, 4);
